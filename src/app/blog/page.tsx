                ...
                >
                  <Link href={`/blog/${post.slug}`}>
                    <div className="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-blue-300 overflow-hidden">
                      <div className={`bg-gradient-to-br from-blue-100 to-purple-100 ${index === 0 ? 'h-64 lg:h-80' : 'h-48'} flex items-center justify-center`}>
                      ...
                      <div className="p-6">
                        ...
                        <h3 className={`font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors duration-200 line-clamp-2 ${index === 0 ? 'text-2xl' : 'text-xl'}`}>
                          {post.title}
                        </h3>
